...
public class PostinganAdapter extends RecyclerView.Adapter<PostinganAdapter.ViewHolder> {
    ...
    public PostinganAdapter(Context context, ArrayList<Instagram> instagrams) {
    ...
    } //membuat tampilan item baru dalam daftar rv dan mengembalikan viewholder yg berisi tampilan tsb.
