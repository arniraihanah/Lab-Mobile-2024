    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_posting.setOnClickListener(btn ->{
            ...
            if (konten.isEmpty()) {
                ...
                Instagram instagram = new Instagram("ariana", "arianaast", konten, R.drawable.foto_profil, selectedImageUri);
                Toast.makeText(getActivity(), "Berhasil menambahkan postingan", Toast.LENGTH_SHORT).show();

                Bundle bundle = new Bundle(); //untuk kirim dan ambil data
                bundle.putParcelable(HomeFragment.EXTRA_INSTAGRAM, instagram); //ambil data dari homefragment pake kata kunci extrainstagram

                HomeFragment homeFragment = new HomeFragment();
                homeFragment.setArguments(bundle); //set bundlenya
