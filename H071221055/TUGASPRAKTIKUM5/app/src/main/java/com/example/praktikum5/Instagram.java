...
//ini parcelable isi dar suatu user
public class Instagram implements Parcelable {
    private String username,name,desc;
    private int fotoProfile,fotoPostingan;
    ...
    public Instagram(String username, String name, String konten, int satu, Uri selectedImageUri) {
        this.username = username;
        this.name = name;
        this.desc = konten;
